...
public class EventChangeTeamConfiguration : IEntityTypeConfiguration<EventChangeTeam>
{
    public void Configure(EntityTypeBuilder<EventChangeTeam> builder)
    {
        builder.ToTable("hlstats_Events_ChangeTeam");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).HasColumnName("id");
        builder.Property(e => e.ServerId).HasColumnName("serverId");
        builder.Property(e => e.PlayerId).HasColumnName("playerId");
        builder.Property(e => e.Team).HasColumnName("team").HasMaxLength(64);
