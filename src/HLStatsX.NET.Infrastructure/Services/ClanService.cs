...
public class ClanService : IClanService
{
    ...
    public Task<PagedResult<Clan>> GetLeaderboardAsync(string game, int page, int pageSize, CancellationToken ct = default) =>
        _clans.GetRankingsAsync(game, page, pageSize, ct);
